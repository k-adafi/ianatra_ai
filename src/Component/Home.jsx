...
const staggerContainer = {
  ...
  const subjects = [
    ...
    { name: "Français", icon: <Languages size={28} />, color: "#3F51B5", path: "/francais" },
    { name: "Allemand", icon: <Languages size={28} />, color: "#3F51B5", path: "/allemand" },
    { name: "Espagnol", icon: <Languages size={28} />, color: "#3F51B5", path: "/espagnol" },
